...
<div class="row">
	  <div class="col">
	  <form  style="width:60%" action="todolist.jsp">
	        	<div class="m-2">
	        			<button class="btn btn-success my-2 my-sm-0" type="submit">Todo List</button>
	        		</div>
	  ...
	  <div class="row">
		  ...
		  <% 
		  	...
		  	ResultSet rs = UserDao.fetchAllTodo(ub.getId());
