            ...
            <form method="POST" action="Login">
                ...
                <div class="form-group">
                    ...
                    <div class="row" style="padding-bottom: 2%;">
 					...
 					<%
					    Boolean status = (Boolean) request.getAttribute("notfound"); 
                        Boolean checkPass = (Boolean) request.getAttribute("checkPass");     		
					    if (status != null) { 
					        if (status) {
					            out.print("<div class='alert alert-danger' role='alert'>Email not found</div>");
					        } 
					    ...
					    if(checkPass != null) {
					    	if(!checkPass) {
					        	out.print("<div class='alert alert-danger' role='alert'>Invalid password</div>");
					        }
					    }
					%>
